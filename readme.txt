...
Plugin URL: https://www.dashboardq.com
...
1. Upload the wp-woo-fake-pay directory to `/wp-content/plugins` directory.
2. Make sure you have WooCommerce installed.
...
4. Navigate to the WooCommerce > Settings > Checkout > Fake Pay.
